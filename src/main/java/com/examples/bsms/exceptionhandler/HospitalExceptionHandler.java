...
import com.examples.bsms.exception.HospitalNotFoundByIdException;
...
public class HospitalExceptionHandler {
    ...
    public ResponseEntity<ErrorStructure<String>> handleUserNotFoundById(HospitalNotFoundByIdException ex) {
